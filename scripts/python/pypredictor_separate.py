...
sx_model = tfk.models.load_model('/home/npasini1/Desktop/dVRK_UserStudy/model_checkpoints/batch256/final/Adnan_sx_5_256.h5')
dx_model = tfk.models.load_model('/home/npasini1/Desktop/dVRK_UserStudy/model_checkpoints/batch256/final/Adnan_dx_5_256.h5')
global X_RealTime
...
def sync_callback(msg1, msg2, msg3, msg4, msg5, msg6, img_msg):
    ...
    try:
        ...
        ECM_position = scene_center - (0.09 + 0.35*distance)*((scene_center - ECM_RCM_pose.p)/(scene_center - ECM_RCM_pose.p).Norm())
