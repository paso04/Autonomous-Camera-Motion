...
def sync_callback(msg1, msg2, msg3, msg4, msg5, msg6, img_msg):
    ...
    # PSM1 pose
    psm1x = msg1.pose.position.x
    psm1y = msg1.pose.position.y
    psm1z = msg1.pose.position.z

    psm1ox = msg1.pose.orientation.x
    psm1oy = msg1.pose.orientation.y
    psm1oz = msg1.pose.orientation.z
    psm1ow = msg1.pose.orientation.w

    # PSM2 pose
    psm2x = msg2.pose.position.x
    psm2y = msg2.pose.position.y
    psm2z = msg2.pose.position.z

    psm2ox = msg2.pose.orientation.x
    psm2oy = msg2.pose.orientation.y
    psm2oz = msg2.pose.orientation.z
    psm2ow = msg2.pose.orientation.w
    ...
    '''
    THINK ABOUT COLLECTING ALSO JOINT ANGLES AS FEATURE AS ILANA NISKY ET AL CITE IT COULD BE A GOOD TYPE OF FEATURE
    '''
...
PSM1position = message_filters.Subscriber("/PSM1/local/measured_cp", PoseStamped)
PSM2position = message_filters.Subscriber("/PSM2/local/measured_cp", PoseStamped)
